                    ...
                    <div class="card-body">
                                ...
                                <table class="table ">
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                <label class="btn btn-secondary btn-sm">
                                                    <input type="radio" <?php echo (!empty($record['handgun_options']) && $record['handgun_options'] == 2)?'checked':'' ?> value="2" name="handgun_options" id="option1" autocomplete="off">
                                                    YES </label>
                                                <label class="btn btn-secondary btn-sm">
                                                    <input type="radio" value="1" checked name="handgun_options" id="option2" autocomplete="off"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                <label class="btn btn-secondary btn-sm">
                                                    <input type="radio" value="2" name="long_gun_options" id="option1" autocomplete="off"
                                                        <?php echo (!empty($record['long_gun_options']) && $record['long_gun_options'] == 2)?'checked':'' ?>>
                                                    YES </label>
                                                <label class="btn btn-secondary btn-sm ">
                                                    <input type="radio" value="1" checked name="long_gun_options" id="option2" autocomplete="off"
                                                        <?php echo (empty($record['long_gun_options']) && $record['long_gun_options'] != 2)?'checked':'' ?>>
                                                    NO </label>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                <label class="btn btn-secondary btn-sm">
                                                    <input type="radio" value="2" name="other_firearm" id="options" autocomplete="off"
                                                        <?php echo (!empty($record['other_firearm']) && $record['other_firearm'] == 2)?'checked':'' ?>>
                                                    YES </label>
                                                <label class="btn btn-secondary btn-sm">
                                                    <input type="radio" value="1" checked name="other_firearm" id="options" autocomplete="off"
                                                        <?php echo (empty($record['other_firearm']) && $record['other_firearm'] != 2)?'checked':'' ?>>
                                                    NO </label>
                                            </div>
                                        </td>
                        ...
                        <div class="row">
                            <div class="col-sm">
                                ...
                                <input type="text" name="name_of_functions" class="form-control multi-in-one" id="fName" aria-describedby=""
                                       placeholder="Name of Function" value="<?php echo (!empty($record['name_of_functions']))?$record['name_of_functions']:'';?>">
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm">
                                <select class="form-control" name="function_state" id="exampleFormControlSelect1">
                                    <option>State</option>
                                    <option <?php echo (!empty($record['function_state']) && $record['function_state'] == 2)?'selected':'' ?> value="2">2</option>
                                    <option <?php echo (!empty($record['function_state']) && $record['function_state'] == 3)?'selected':'' ?> value="3">3</option>
                                    <option <?php echo (!empty($record['function_state']) && $record['function_state'] == 4)?'selected':'' ?> value="4">4</option>
                                    <option <?php echo (!empty($record['function_state']) && $record['function_state'] == 5)?'selected':'' ?> value="5">5</option>
                                </select>
                            </div>
                            <div class="col-sm">
                                <select class="form-control" name="function_city" id="exampleFormControlSelect1">
                                    <option>City</option>
                                    <option <?php echo (!empty($record['function_city']) && $record['function_city'] == 2)?'selected':'' ?> value="2" value="2">2</option>
                                    <option <?php echo (!empty($record['function_city']) && $record['function_city'] == 3)?'selected':'' ?> value="3" value="3">3</option>
                                    <option <?php echo (!empty($record['function_city']) && $record['function_city'] == 4)?'selected':'' ?> value="4" value="4">4</option>
                                    <option <?php echo (!empty($record['function_city']) && $record['function_city'] == 5)?'selected':'' ?> value="5" value="5">5</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm">
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        <input type="text" name="issuing_authority" class="form-control multi-in-one" id="fName"
                                               aria-describedby="" placeholder="Issuing Authority" value="<?php echo (!empty($record['issuing_authority']))?$record['issuing_authority']:'';?>">
                                    ...
                                    <div class="col-md-5 snap-id">
                                        ...
                                        <input type="file" name="identification_photo_id" id="identification_photo_id" class="over_hidden" value="<?php echo (!empty($record['identification_photo_id']))?$record['identification_photo_id']:'';?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-7">
                                        <input type="text" class="form-control multi-in-one" id="fName"
                                               aria-describedby="" name="number_identification" placeholder="Number of Identification"
                                               value="<?php echo (!empty($record['number_identification']))?$record['number_identification']:'';?>">
                                    </div>
                                    <div class="col-md-5 snap-id">
                                        <input id="datepicker" name="identification_exp_date" placeholder="Expiration Date"
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <input type="text" class="form-control multi-in-one" name="government_issued_documentation" id="fName" aria-describedby=""
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <input type="text" name="exception_documentation" class="form-control multi-in-one" id="fName" aria-describedby=""
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table table-striped">
                        <tr>
                            <td>19.a. Date the transferee's/buyer's identifying information in Section A was transmitted
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="transaction_number" class="form-control multi-in-one" id="fName" aria-describedby=""
                                       placeholder="State transaction number"
                                       value="<?php echo (!empty($record['transaction_number']))?$record['transaction_number']:'';?>">
                            </td>
                        </tr>
                        <tr>
                            <td>19.c. The response initially (first) provided by NICS or the appropriate State agency
                                was:
                            </td>
                            <td>
                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                    <label class="btn btn-secondary btn-sm">
                                        <input type="radio" checked value="1" name="c19_nics_options" id="option1" autocomplete="off"
                                            <?php echo (!empty($record['c19_nics_options']) && $record['c19_nics_options'] == 1)?'checked':'' ?>>
                                        Proceed </label>
                                    <label class="btn btn-secondary btn-sm">
                                        <input type="radio" value="2" name="c19_nics_options" id="option2" autocomplete="off"
                                            <?php echo (!empty($record['c19_nics_options']) && $record['c19_nics_options'] == 2)?'checked':'' ?>>
                                        Denied </label>
                                    <label class="btn btn-secondary btn-sm">
                                        <input type="radio" value="3" name="c19_nics_options" id="option2" autocomplete="off"
                                            <?php echo (!empty($record['c19_nics_options']) && $record['c19_nics_options'] == 3)?'checked':'' ?>>
                                        Canceled </label>
                                    <label class="btn btn-secondary btn-sm">
                                        <input type="radio" value="4" name="c19_nics_options" id="option2" autocomplete="off"
                                ...
                                <label>The firearm(s) may be transferred on </label><em>[if State law permits
                                    (optional)]</em>
                                <input type="text" name="state_transaction" class="form-control multi-in-one" id="fName" aria-describedby=""
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                    <label class="btn btn-secondary btn-sm">
                                        <input type="radio" checked value="1" name="d19_nics_options" id="option1" autocomplete="off"
                                            <?php echo (!empty($record['d19_nics_options']) && $record['d19_nics_options'] == 1)?'checked':'' ?>>
                                        Proceed </label>
                                    <label class="btn btn-secondary btn-sm">
                                        <input type="radio" value="2" name="d19_nics_options" id="option2" autocomplete="off"
                                            <?php echo (!empty($record['d19_nics_options']) && $record['d19_nics_options'] == 2)?'checked':'' ?>>
                                        Denied </label>
                                    <label class="btn btn-secondary btn-sm">
                                        <input type="radio" value="3" name="d19_nics_options" id="option2" autocomplete="off"
                                            <?php echo (!empty($record['d19_nics_options']) && $record['d19_nics_options'] == 3)?'checked':'' ?>>
                                        Canceled </label>
                                    <label class="btn btn-secondary btn-sm">
                                        <input type="radio" value="4" name="d19_nics_options" id="option2" autocomplete="off"
                                            <?php echo (!empty($record['d19_nics_options']) && $record['d19_nics_options'] == 4)?'checked':'' ?>>
                                        Overturned </label>
                                    <label class="btn btn-secondary btn-sm">
                                        <input type="radio"  value="5" name="d19_nics_options" id="option2" autocomplete="off"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                    <label class="btn btn-secondary btn-sm">
                                        <input type="radio" checked value="1" name="e19_nics_options" id="option1" autocomplete="off"
                                            <?php echo (!empty($record['e19_nics_options']) && $record['e19_nics_options'] == 1)?'checked':'' ?>>
                                        Proceed </label>
                                    <label class="btn btn-secondary btn-sm">
                                        <input type="radio" value="2" name="e19_nics_options" id="option2" autocomplete="off"
                                            <?php echo (!empty($record['e19_nics_options']) && $record['e19_nics_options'] == 2)?'checked':'' ?>>
                                        Denied </label>
                                    <label class="btn btn-secondary btn-sm">
                                        <input type="radio" value="3" name="e19_nics_options" id="option2" autocomplete="off"
                        ...
                        <tr>
                            <td>19.f. The name and Brady identification number of the NICS examiner.<em> (Optional)</em>
                            </td>
                            <td>
                                <input type="text" name="f19_name" class="form-control multi-in-one" id="fName" aria-describedby=""
                                       placeholder="Name"
                                       value="<?php echo (!empty($record['f19_name']))?$record['f19_name']:'';?>">
                                <input type="text" name="f19_number" class="form-control" id="fName" aria-describedby=""
                                       placeholder="Number"
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="g19_name" class="form-control multi-in-one" id="fName" aria-describedby=""
                                       placeholder="Name"
                                       value="<?php echo (!empty($record['g19_name']))?$record['g19_name']:'';?>">
                            </td>
                        </tr>
                        <tr>
                            <td>20. No NICS check was required because a background check was completed during the NFA
                                approval process on the individual who will receive the NFA firearm(s), as reflected on
                            ...
                            <td>
                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                    <label class="btn btn-secondary btn-sm">
                                        ...
                                        YES </label>
                                    <label class="btn btn-secondary btn-sm">
                                        <input type="radio" name="nifs_20" checked value="1" id="option2" autocomplete="off"
                                            <?php echo (empty($record['e19_nics_options']) || $record['e19_nics_options'] != 2)?'checked':'' ?>>
                                        NO </label>
                                </div>
                        ...
                        <tr>
                            <td>21. No NICS check was required because the transferee/buyer has a valid permit from the
                                State where the transfer is to take place, which qualifies as an exemption to NICS. <em>(See
                            ...
                            <td>
                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                    <label class="btn btn-secondary btn-sm">
                                        ...
                                        YES </label>
                                    <label class="btn btn-secondary btn-sm">
                                        <input type="radio" value="1" checked name="nifc_21" id="option2" autocomplete="off"
                                            <?php echo (empty($record['nifc_21']) || $record['nifc_21'] != 2)?'checked':'' ?>>
                                        NO </label>
                                </div>
                            </td>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input type="text" name="state_permit_dade" class="form-control" id="fName" aria-describedby=""
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input type="text" name="permit_number" class="form-control" id="fName" aria-describedby=""
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <small>I certify that: (1) I have read and understand the Notices, Instructions, and
                                Definitions on this ATF Form 4473; (2) the information recorded in Sections B and D is
                                true, correct, and complete; and (3) this entire transaction record has been completed
                                at my licensed business premises ("licensed premises" includes business temporarily
                                conducted from a qualifying gun show or event in the same State in which the licensed
                                premises is located) unless this transaction has met the requirements of 18 U.S.C.
                                922(c). Unless this transaction has been denied or cancelled, I further certify on the
                                basis of — (1) the transferee's/buyer's responses in Section A (and Section C, if
                                applicable); (2) my verification of the identification recorded in question 18 (and my
                                re-verification at the time of transfer, if Section C was completed); and (3) State or
                                local law applicable to the firearms business — it is my belief that it is not unlawful
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="transferror_seller_fname" id="fName" aria-describedby=""
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="transferror_seller_title" id="fName" aria-describedby=""
                                       placeholder="Title"
                        ...
                        <div class="col-sm">
                            ...
                            <button type="button" class="btn btn-success btn-block " id="save_section_b">Submit</button>
                        </div>
