...
class FormsListController extends CI_Controller
{
    ...
    public function pdfDownload()
    {
        ...
        $data = array(
            ...
            'form1[0].page3[0].TextField19[0]'       => $secD_firearms[0]['manufacturer_importer'],
            'form1[0].page3[0].TextField19[1]'       => $secD_firearms[1]['manufacturer_importer'],
            'form1[0].page3[0].TextField19[2]'       => $secD_firearms[2]['manufacturer_importer'],
            'form1[0].page3[0].TextField19[3]'       => $secD_firearms[3]['manufacturer_importer'],
            'form1[0].page3[0].TextField19[4]'       => $secD_firearms[0]['model'],
            'form1[0].page3[0].TextField19[5]'       => $secD_firearms[1]['model'],
            'form1[0].page3[0].TextField19[6]'       => $secD_firearms[2]['model'],
            'form1[0].page3[0].TextField19[7]'       => $secD_firearms[3]['model'],
            'form1[0].page3[0].TextField19[8]'       => $secD_firearms[0]['serial_number'],
            'form1[0].page3[0].TextField19[9]'       => $secD_firearms[0]['serial_number'],
            'form1[0].page3[0].TextField19[10]'      => $secD_firearms[0]['serial_number'],
            'form1[0].page3[0].TextField19[11]'      => $secD_firearms[0]['serial_number'],
            'form1[0].page3[0].TextField19[12]'      => $secD_firearms[0]['type'],
            'form1[0].page3[0].TextField19[13]'      => $secD_firearms[0]['type'],
            'form1[0].page3[0].TextField19[14]'      => $secD_firearms[0]['type'],
            'form1[0].page3[0].TextField19[15]'      => $secD_firearms[0]['type'],
            'form1[0].page3[0].TextField19[16]'      => $secD_firearms[0]['caliber_gauge'],
            'form1[0].page3[0].TextField19[17]'      => $secD_firearms[0]['caliber_gauge'],
            'form1[0].page3[0].TextField19[18]'      => $secD_firearms[0]['caliber_gauge'],
            'form1[0].page3[0].TextField19[19]'      => $secD_firearms[0]['caliber_gauge'],
